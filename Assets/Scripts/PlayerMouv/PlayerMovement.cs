...
public class PlayerMovement : MonoBehaviour {
    ...
    private void Jump() {
        if (grounded && readyToJump) {
            ...
            //Add jump forces
            rb.AddForce(Vector2.up * jumpForce * 1.5f * multiplierJ);
            rb.AddForce(normalVector * jumpForce * 0.5f * multiplierJ);
            
            //Reset y velocity while falling
